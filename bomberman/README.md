...
BOMB\_BLAST\_RADIUS\_INCREASE(&#39;+&#39;), // увеличивает радиус взрыва бомбы (радиус +2 к текущему).

// Действует только для новых бомб.

BOMB\_COUNT\_INCREASE(&#39;c&#39;), // Увеличивает количество доступных игроку бомб (+3 к текущему уровню по-умолчанию).

BOMB\_IMMUNE(&#39;i&#39;), // Дает иммунитет от взрыва бомб.

BOMB\_REMOTE\_CONTROL(&#39;r&#39;), // Дистанционный взрыватель. Срабатывает при повторном действии. 3 взрывателя по умолчанию.
